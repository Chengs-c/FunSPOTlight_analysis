...
data_performance_pearson = data.frame(matrix(rep(0,(3 * num_repeat * num_cl_n*n_syn_mixt)*3), 
                                             nrow = (3 * num_repeat * num_cl_n*n_syn_mixt),
                                             ncol = 3))
colnames(data_performance_pearson) = c("cl_n", "value", "num_repeat")
#data_performance_JSD[, 3] = rep(c("0.25", "0.50", "0.75"), num_cl_n * num_repeat)

data_performance_RMSE = data.frame(matrix(rep(0,(2 * num_repeat * num_cl_n*n_syn_mixt)*4), nrow = (2 * num_repeat * num_cl_n*n_syn_mixt),
                                             ncol = 4))
...
setwd("D:\\research\\undergraduate\\fda_ST\\parameter_test\\cl_n")
#saveRDS(data_performance_pearson,"data_performance_pearson.rds")
saveRDS(data_performance_RMSE,"data_performance_RMSE2.rds")
